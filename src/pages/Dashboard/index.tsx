    ...
    return (
        <>
            <div className='max-w-6xl mx-auto flex flex-col'>
                <div className='mb-8'>
                    <h3 className='text-2xl font-bold text-slate-800'>Недавние предметы</h3>
                    <p className='text-slate-500 text-sm mt-1'>
                        Здесь отображены последние предметы, к которым вы присоединились. Для
                        получения полного списка перейдите на страницу с предметами.
                    </p>
                </div>
                {isLoading ? (

            ...
            <div className='bg-white w-full max-w-lg rounded-3xl shadow-2xl p-8'>
                <div className='flex items-center justify-between mb-6'>
                    <div className='flex items-center gap-3'>
                        ...
                        <h3 className='text-xl font-bold text-slate-800'>Параметры создания команд</h3>
                    </div>
                ...
                <form onSubmit={handleSubmit} className='space-y-5'>
                    ...
                    <div className='p-4 bg-slate-50 rounded-xl border border-slate-200'>
                        <div className='flex items-center justify-between gap-3'>
                            <div>
                                <p className='text-sm font-semibold text-slate-700'>Капитан команды</p>
                    ...
                    <div className='p-4 bg-blue-50 border-b-blue-50 rounded-xl border border-blue-100'>
                        <p className='text-xs text-blue-700 font-semibold mb-1'>Метод принятия решения</p>
                    ...
                    <div className='p-4 bg-blue-50 border-b-blue-50 rounded-xl border border-blue-100'>
                        <p className='text-xs text-blue-700 font-semibold mb-1'>ℹ️ После сохранения</p>
                        <p className='text-xs text-blue-600'>
